...
public class TestOrcWriterOptions
{
    ...
    public void tesDefaultValues()
    {
        ...
        assertEquals(Optional.empty(), options.getDwrfStreamOrderingConfig());
    }
    ...
    public void testProperties()
    {
        ...
        Optional<DwrfStreamOrderingConfig> dwrfStreamOrderingConfig = Optional.of(new DwrfStreamOrderingConfig(ImmutableMap.of(1, keyOrder)));
        ...
        OrcWriterOptions.Builder builder = OrcWriterOptions.builder()
                ...
                .withDwrfStreamOrderingConfig(dwrfStreamOrderingConfig);
        ...
        assertEquals(options.getDwrfStreamOrderingConfig(), dwrfStreamOrderingConfig);
    }
    ...
    public void testToString()
    {
        ...
        String expectedString = "OrcWriterOptions{flushPolicy=DefaultOrcWriterFlushPolicy{stripeMaxRowCount=1100000, " +
                ...
                "dwrfStreamOrderingConfig=Optional[DwrfStreamOrderingConfig{colIdToStreamOrder={1=[intKey: 1\n" +
                ", intKey: 2\n]}}]}";
